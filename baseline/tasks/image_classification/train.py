...
from baseline.data.custom_datasets import ImageNet
from torchvision import datasets
from torchvision import transforms
from baseline.tasks.image_classification.imagenet_classes import IMAGENET2012_CLASSES
...
from baseline.utils.losses import image_classification_loss # Used by CTM, LSTM
        ...
        for bi in range(start_iter, args.training_iterations):
            ...
            with torch.autocast(device_type="cuda" if "cuda" in device else "cpu", dtype=torch.float16, enabled=args.use_amp):
                ...
                if args.model == 'ctm':
                    ...
                    if args.tick_compute_weight > 0 and args.model == 'ctm':
