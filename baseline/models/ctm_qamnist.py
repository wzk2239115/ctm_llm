...
class ContinuousThoughtMachineQAMNIST(ContinuousThoughtMachine):
    ...
    def forward(self, x, z, track=False, return_per_tick_synch=False):
        ...
        # --- Compute effective BP steps ---
        effective_bp_steps = min(bp_steps_cfg, total_iterations) if bp_steps_cfg > 0 else total_iterations
        ...
        for stepi in range(total_iterations):
            ...
            grad_enabled_this_tick = stepi >= total_iterations - effective_bp_steps
