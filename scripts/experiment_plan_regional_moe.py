...
def parse_args():
    parser = argparse.ArgumentParser(description="CTM regional multi-pass MoE experiment plan helper")
    ...
    p.add_argument("--output", default="runs/experiment_plans/regional_moe_plan.csv")
    p.add_argument("--batch_profile", default=None)
    p.set_defaults(func=print_commands)

    p = sub.add_parser("final-plan", parents=[common])
    p.add_argument("--output", default="runs/experiment_plans/regional_moe_final_plan.csv")
    p.add_argument("--batch_profile", default="runs/metrics/regional_moe_batch_profile.csv")
    ...
    p.add_argument("--output", default="runs/experiment_plans/regional_moe_batch_tune_plan.csv")
    ...
    p.add_argument("--output", default="runs/metrics/regional_moe_batch_profile_quick.csv")
    p.add_argument("--report_output", default="runs/metrics/regional_moe_quick_probe_report.csv")
    ...
    p.add_argument("--metrics_dir", default="runs/metrics")
    p.add_argument("--output", default="runs/metrics/regional_moe_summary.csv")
    p.set_defaults(func=summarize)

    p = sub.add_parser("recommend-batches")
    p.add_argument("--metrics_dir", default="runs/metrics")
    p.add_argument("--output", default="runs/metrics/regional_moe_batch_profile.csv")
    p.add_argument("--target_memory_gb", type=float, default=80.0)
    p.add_argument("--memory_util", type=float, default=0.90)
    ...
    p.add_argument("--metrics_dir", default="runs/metrics")
    p.add_argument("--output", default="runs/metrics/regional_moe_batch_probe_report.csv")
    p.add_argument("--batch_sizes", type=int, nargs="+", default=[2, 4, 6, 8, 10, 12])
    p.add_argument("--tune_steps", type=int, default=80)
    p.add_argument("--tune_log_interval", type=int, default=20)
