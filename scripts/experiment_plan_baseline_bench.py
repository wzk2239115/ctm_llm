...
DEFAULT_MASTER_ADDR = __import__("_pool_config").MASTER_ADDR
DEFAULT_PORT = __import__("_pool_config").PORT
DEFAULT_BASELINE_NODES = __import__("_pool_config").BASELINE_NODES
